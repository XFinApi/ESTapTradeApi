/*******************************************************
 * ESTapTradeApiSimpleDemoJavaIdeaIC2018
 * www.xfinapi.com
 *******************************************************/
...
public class Main {
    ...
    static void MarketTest() {
        ...
        market = XFinApi.TradeApi.ITradeApi.XFinApi_CreateMarketApi("XTA_W32/Api/ESTap_v9.0.3.11/XFinApi.ESTapTradeApi.dll", err);
        ...
        cfgs.set("AuthCode", Cfg.MarketAuthCode);
    ...
    static void TradeTest() {
        ...
        trade = XFinApi.TradeApi.ITradeApi.XFinApi_CreateTradeApi("XTA_W32/Api/ESTap_v9.0.3.11/XFinApi.ESTapTradeApi.dll", err);
        ...
        XFinApi.TradeApi.OpenParams openParams = new XFinApi.TradeApi.OpenParams();
        StdStringMap cfgs = new StdStringMap();
        cfgs.set("AuthCode", Cfg.TradeAuthCode);
        openParams.setConfigs(cfgs);
