/*******************************************************
* ESTapTradeApiSimpleDemoLinux64GCC
* www.xfinapi.com
*******************************************************/
...
void MarketTest()
{
	...
	market = XFinApi_CreateMarketApi("XTA_L64/Api/ESTap_v9.0.3.11/XFinApi.ESTapTradeApi.so", &err);
...
void TradeTest()
{
	...
	trade = XFinApi_CreateTradeApi("XTA_L64/Api/ESTap_v9.0.3.11/XFinApi.ESTapTradeApi.so", &err);
