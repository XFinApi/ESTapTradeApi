...
- ESTapTradeApi : 是基于TapQuoteAPI v9.3.1.1、TapTradeAPI v9.0.3.11的一个统一封装，可实现多语言的使用，简化开发过程。
- QQ群：650920857
- 官方网址 :  www.xfinapi.com

#### 软件架构
- ITradeApi ： 统一接口，位于Cpp目录下，使用者可直接引用此目录的头文件和lib进行开发，ESTapTradeApi.dll会动态加载到程序中，不进行依赖。
- ESTapTradeApi.dll : 对底层TapQuoteAPI.dll、TapTradeAPI.dll的封装。
